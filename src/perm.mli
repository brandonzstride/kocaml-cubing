...
val perform_fixed_move : t -> Move.All_fixed_move.t -> t (* Fixed move is performed after the permutation *)
val perform_fixed_move_list : t -> Move.All_fixed_move.t list -> t (* Performs moves in the order given *)
