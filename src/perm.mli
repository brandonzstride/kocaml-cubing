...
val perform_fixed_move : t -> Move.Fixed_move.Super.t -> t (* Fixed move is performed after the permutation *)
val perform_fixed_move_list : t -> Move.Fixed_move.Super.t list -> t (* Performs moves in the order given *)
